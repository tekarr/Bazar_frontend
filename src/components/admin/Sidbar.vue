<template>
    ...
    <aside id="logo-sidebar" class="fixed top-0 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        ...
        <ul class="space-y-4 font-medium">
            ...
            <li>
                <router-link to="/admin/notification" :class="sidebarLinkClass('/admin/notification')" class="flex items-center p-4 text-gray-900 rounded-lg   hover:bg-pink-600 group">
                ...
                <span class="flex-1 ms-3 whitespace-nowrap ">{{ $t('Notifications') }}</span>
                 <span class="inline-flex items-center justify-center w-4 h-4 p-4 ms-3 text-xs font-medium text-gray-100 bg-pink-400 rounded-full">{{store.getters["auth/user"].unread_notifications}}</span>
            </router-link>
            </li>
            <li>
            ...
            <li>
                <router-link to="/admin/stores" :class="sidebarLinkClass('/admin/stores')"  class="flex items-center p-4 text-gray-900 rounded-lg   hover:bg-pink-600 group">
            ...
            <li>
                <router-link to="/admin/orders" :class="sidebarLinkClass('/admin/orders')"  class="flex items-center p-4 text-gray-900 rounded-lg   hover:bg-pink-600 group">
            ...
            <li>
                <router-link to="/admin/profile" :class="sidebarLinkClass('/admin/profile')"  class="flex items-center p-4 text-gray-900 rounded-lg   hover:bg-pink-600 group">
