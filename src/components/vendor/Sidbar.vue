<template>
    ...
    <aside id="logo-sidebar" class="fixed top-0 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        ...
        <ul class="space-y-4 font-medium">
            <li>
                <router-link to="/vendor/dashboard" :class="sidebarLinkClass('/vendor/dashboard')" class="flex items-center p-4 text-gray-900 rounded-lg   hover:bg-pink-600 group">
            ...
            <li>
              <router-link to="/vendor/notification" :class="sidebarLinkClass('/vendor/notification')" class="flex items-center p-4 text-gray-900 rounded-lg   hover:bg-pink-600 group">
            ...
            <li>
                <router-link to="/vendor/store" :class="sidebarLinkClass('/vendor/store')"  class="flex items-center p-4 text-gray-900 rounded-lg  hover:bg-pink-600  group">
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">{{ $t('Store') }}</span>
                </router-link>
            </li>
            <li>
                <router-link to="/vendor/orders" :class="sidebarLinkClass('/vendor/orders')"  class="flex items-center p-4 text-gray-900 rounded-lg  hover:bg-pink-600  group">
            ...
            <li>
                <router-link to="/vendor/profile" :class="sidebarLinkClass('/vendor/profile')"  class="flex items-center p-4 text-gray-900 rounded-lg  hover:bg-pink-600  group">
            ...
            <li>
                <router-link to="/" :class="sidebarLinkClass('/')"  class="flex items-center p-4 text-gray-900 rounded-lg  hover:bg-pink-600 group">
                    ...
                    <span @click="logout" class="flex-1 ms-3 whitespace-nowrap">{{ $t('logout') }}</span>
                </router-link>
            </li>
        </ul>
        </div>
