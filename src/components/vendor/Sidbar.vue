<template>
    ...
    <aside id="logo-sidebar" class="fixed top-0 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        ...
        <ul class="space-y-4 font-medium">
            ...
            <li>
                <router-link to="/vendor/notification" :class="sidebarLinkClass('/vendor/notification')" class="flex items-center p-4 text-gray-900 rounded-lg dark:text-white hover:bg-pink-600">
                ...
                <!-- <span class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-gray-100 bg-pink-300 rounded-full">3</span> -->
            </router-link>
            </li>
            <li>
            ...
            <li>
                <router-link to="/vendor/orders" :class="sidebarLinkClass('/vendor/orders')"  class="flex items-center p-4 text-gray-900 rounded-lg  hover:bg-pink-600 dark:hover:bg-gray-700 group">
            ...
            <li>
                <router-link to="/vendor/profile" :class="sidebarLinkClass('/vendor/profile')"  class="flex items-center p-4 text-gray-900 rounded-lg  hover:bg-pink-600 dark:hover:bg-gray-700 group">
